...
.. list-table::
   ...
   * - > `1037 <http://fixwiki.org/fixwiki/UnderlyingDeliveryAmount>`_
...
.. list-table::
   ...
   * - > `986 <http://fixwiki.org/fixwiki/UnderlyingCollectAmount>`_
   ...
   * - > `985 <http://fixwiki.org/fixwiki/UnderlyingPayAmount>`_
   ...
   * - > `988 <http://fixwiki.org/fixwiki/UnderlyingSettlementStatus>`_
